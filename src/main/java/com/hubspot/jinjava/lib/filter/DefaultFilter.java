...
@JinjavaDoc(
    ...
    params={
        @JinjavaParam(value="value", desc=""),
        @JinjavaParam(value="default_value", desc=""),
        @JinjavaParam(value="boolean", type="boolean", defaultValue="False", desc="set to True to use with variables which evaluate to false", desc="")
    },
    snippets={
        @JinjavaSnippet(
