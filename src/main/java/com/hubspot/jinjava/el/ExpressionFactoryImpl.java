...
public class ExpressionFactoryImpl extends jakarta.el.ExpressionFactory {
    ...
    public enum Profile {
        ...
        Profile(EnumSet<Feature> features) {
     ...
     *
     * @param profile builder profile (features may be overridden in <code>el.properties</code>)
     *
     * @since 2.2
     */
     ...
     * @param properties used to initialize this factory (could be <code>null</code>)
     *
     * @since 2.2
     */
