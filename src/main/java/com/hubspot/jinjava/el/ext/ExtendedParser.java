...
public class ExtendedParser extends Parser {
  ...
  static final Scanner.ExtensionToken REGULAR_DIV = RegularDivOperator.TOKEN;
  ...
  static {
    ...
    ExtendedScanner.addKeyToken(RegularDivOperator.TOKEN);
  ...
  public ExtendedParser(Builder context, String input) {
    ...
    putExtensionHandler(RegularDivOperator.TOKEN, RegularDivOperator.HANDLER);
