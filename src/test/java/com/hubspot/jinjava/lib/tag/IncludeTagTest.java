...
public class IncludeTagTest {
  ...
  public void itHasIncludesReferenceInContext() throws Exception {
    ...
    assertThat(dependencies.get("extension_resources")).isNotEmpty();

    assertThat(dependencies.get("extension_resources").contains("{% include \"tags/includetag/hello.html\" %}"));
    assertThat(dependencies.get("extension_resources").contains("{% include \"tags/includetag/cat.html\" %}"));
  }
