...
public class DateTimeFormatFilterTest {
  ...
  public void itConvertsDatetimesByLocales() {
    ...
    assertThat(interpreter.renderFlat("{{ d|datetimeformat('%A, %e %B', 'UTC', 'sv') }}")).isEqualTo("onsdag, 6 november");
  }
  ...
  public void itDefaultsToEnglishForBadLocaleValues() {
    ...
    assertThat(interpreter.renderFlat("{{ d|datetimeformat('%A, %e %B', 'UTC', 'not_a_locale') }}")).isEqualTo("Wednesday, 6 November");
  }
}
