...
public class TrailingNewlineTest {
  ...
  @Test
  public void itKeepsTrailingNewlineByDefault() {
    // On the 2.8.x line the default (LegacyOverrides.NONE) preserves the trailing
    // newline, matching Jinjava's historical behaviour.
    Jinjava jinjava = new Jinjava();
    assertThat(jinjava.render(TEMPLATE_WITH_TRAILING_NEWLINE, new HashMap<>()))
      .isEqualTo("hello\n");
  }
